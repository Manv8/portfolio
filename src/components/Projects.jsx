...
<div className="mb-8 flex flex-wrap  lg:justify-center">
        ...
        <motion.div
          ...
          <p className='mb-4 text-neutral-400  text-wrap text-justify'>Developed an interactive music player using HTML, CSS,and JavaScript,featuring dynamic song navigation, search, and play/pause controls.Enhancing user experience with smooth transitions between song playback and search results.</p>
